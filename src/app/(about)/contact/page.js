...
export default function Contact() {
	return (
		<section className="w-full h-auto md:h-[75vh] border-b-2 border-solid border-dark dark:border-light flex  flex-col md:flex-row items-center justify-center text-dark dark:text-light">
			<div className="flex items-center justify-center text-center w-full sm:w-4/5 md:w-2/5 h-full md:border-r-2 border-solid border-dark dark:border-light">
				<h1 className="text-center text-5xl font-extrabold my-10 items-center justify-center">
					CONTACT
				</h1>
			</div>
