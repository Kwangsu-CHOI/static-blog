...
export const KakaoIcon = ({ className, ...rest }) => {
	return <Image src="/kakao.png" width={42} height={42} alt="kakao" />;
};
...
export const EmailIcon = ({ className, ...rest }) => {
	return (
		...
		>
			...
			/>
			<g fill="#fff">
				<path d="m32 54c-12.1 0-22-9.9-22-22s9.9-22 22-22 22 9.9 22 22c0 4.5-1.4 8.9-3.9 12.6-.6.8-1.7 1.1-2.6.6-.3-.2-8.1-4.2-8.1-13.1v-8.8c0-1.1.9-2 2-2s2 .9 2 2v8.8c0 4.3 2.6 7.1 4.4 8.5 1.4-2.6 2.2-5.6 2.2-8.6 0-9.9-8.1-18-18-18s-18 8.1-18 18 8.1 18 18 18c2.9 0 5.7-.7 8.2-2 1-.5 2.2-.1 2.7.9s.1 2.2-.9 2.7c-3 1.6-6.5 2.4-10 2.4z" />
				<path d="m32 24.6c4.1 0 7.4 3.3 7.4 7.4s-3.3 7.4-7.4 7.4-7.4-3.3-7.4-7.4 3.3-7.4 7.4-7.4m0-4c-6.3 0-11.4 5.1-11.4 11.4s5.1 11.4 11.4 11.4 11.4-5.1 11.4-11.4-5.1-11.4-11.4-11.4z" />
			</g>
		</svg>
	);
};
